...
%
The equipment and materials that are needed to perform the experiments are shown in \cref{subfig:setup_total}. A detailed
view of the angular sensor assembly is seen in \cref{subfig:setup_detailed}.\par
%
\begin{figure}[h]
	\centering
	\subfloat[1: Computer running \textsc{RealTerm}, 2: Angular sensor assembly, 3: Zero adjustment, 4: Torsion wire, 5: PSU in constant current mode powering the eddy current brake.\label{subfig:setup_total}]{\includegraphics[width=.8\textwidth]{aufbau/setup_total_num.jpg}}\\
	\subfloat[Detailed view of the angular sensor assembly. 2a: Copper plate with scale in degree, 2b: Capacitor plates, 2c: Eddy current brake,
	6: \micro C board.\label{subfig:setup_detailed}]{\includegraphics[width=.5\textwidth]{aufbau/setup_pendulum_side_num.jpg}}
