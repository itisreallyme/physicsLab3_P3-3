...
%\usepackage{exscale}
\usepackage{ellipsis} % fixes spacing between ellipses
\usepackage{graphicx}
\usepackage{float}
%\usepackage{floatflt}
%----------------------------------------
\usepackage{gensymb} % provides \degree, \ohm, \micro, etc
%\usepackage{helvet}
...
% \usepackage{nicefrac} % part of units
%\usepackage{picins} %----------
\usepackage{paralist} %--------
% \usepackage{parallel}  % Provides a parallel environment which allows two potentially different texts to be typeset in two columns, while maintaining alignment
\usepackage{pdfpages} %-------
...
\usepackage[per-mode=fraction,parse-numbers=false]{siunitx} %nicht zusammen mit sistyle %---------
...
\usepackage{tocbasic}
%\usepackage{tikz}
% \usepackage{times} % deprecated. replaced by mathptmx
\usepackage{mathptmx}
\usepackage{units} %----------
\usepackage{url}
\usepackage{wrapfig} %----------
% \usepackage{xr-hyper} % now part of hyperref
